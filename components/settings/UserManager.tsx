      ...
      <div className="mb-5 rounded-lg border border-white/10 bg-[#ffffff05] p-4">
        ...
        <div className="flex gap-3">
          <div className="relative flex-1">
            <User className="absolute left-3 top-1/2 h-3.5 w-3.5 -translate-y-1/2 text-white/50" />
            <Input
            ...
            >
              ...
              <div className="flex justify-center">
                <Button
                  ...
                  className="h-7 w-7 text-white/60 hover:bg-[#EF4444]/10 hover:text-[#EF4444] disabled:opacity-30"
                >
